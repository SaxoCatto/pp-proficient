...
/**
 * Solves the 1 dimension heat eqn using explicit finite difference method.
 *
 * @param u           Pointer to the initial temperature array.
 * @param params      Pointer to the HeatEquationParams structure containing simulation parameters.
 */
int
solve_heat_equation (double *u, const HeatEquationParams *params)
{
